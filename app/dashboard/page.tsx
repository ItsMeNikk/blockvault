...
function CredentialRow({
  ...
  return (
    <div className={`flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 px-4 sm:px-5 py-3 sm:py-3.5 hover:bg-[#1F1F1E] transition-colors duration-100 ${!isLast ? "border-b border-[#282824]/50" : ""}`}>
      ...
      <div className="w-full sm:flex-1 min-w-0 pl-9 sm:pl-0">
        <p className="text-sm text-[#9A9690] truncate">{cred.username}</p>
      </div>
      <div className="hidden md:block w-24 text-right shrink-0">
        <span className="text-sm text-[#52504D] tracking-widest">{revealed ? cred.password : "••••••••"}</span>
      </div>
      <div className="flex items-center gap-0.5 ml-auto shrink-0">
        <button onClick={() => setRevealed((v) => !v)} className="flex h-7 w-7 items-center justify-center rounded-md text-[#52504D] hover:bg-[#282824] hover:text-[#9A9690] transition-colors duration-100" title={revealed ? "Hide" : "Reveal"}>
          {revealed ? (
        ...
        <button onClick={() => handleCopy(cred.password)} className="flex h-7 w-7 items-center justify-center rounded-md text-[#52504D] hover:bg-[#282824] hover:text-[#9A9690] transition-colors duration-100" title="Copy">
        ...
        <button onClick={() => onEdit(cred)} className="flex h-7 w-7 items-center justify-center rounded-md text-[#52504D] hover:bg-[#282824] hover:text-[#9A9690] transition-colors duration-100" title="Edit">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg>
        </button>
        <button onClick={() => onDelete(cred)} className="flex h-7 w-7 items-center justify-center rounded-md text-[#52504D] hover:bg-[#B4533B]/20 hover:text-[#B4533B] transition-colors duration-100" title="Delete">
      ...
      <div className="min-h-screen lg:ml-52 flex flex-col">
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 max-w-5xl">
          ...
          <div className="mt-4 sm:mt-5 flex items-center justify-between">
            ...
            <button onClick={handleSignOut} disabled={signingOut} className="flex items-center gap-1.5 text-xs text-[#52504D] hover:text-[#9A9690] transition-colors duration-150 disabled:opacity-50 lg:hidden">
